...
exports.updateMembership = async (req, res) => {
  try {
    ...
    if (startDate) user.membershipDetails.startDate = startDate;
    if (endDate) user.membershipDetails.endDate = endDate;
...
exports.recordPayment = async (req, res) => {
  try {
    ...
    if (!user.membershipDetails.paymentHistory) {
      user.membershipDetails.paymentHistory = [];
    }
    ...
    user.membershipDetails.paymentHistory.push(payment);
    user.membershipDetails.lastPaymentDate = new Date();
    user.membershipDetails.feesPaid = true;
...
exports.getPaymentHistory = async (req, res) => {
  try {
    ...
    const paymentHistory = user.membershipDetails?.paymentHistory || [];
